...
exports.postProducts = async (req, res) => {
  ...
  try {
    ...
    if (e.message.includes('Please enter Amazon or Flipkart product link')) {
...
const getSite = link => {
  if (link.includes('amazon.in')) {
    ...
    throw Error('Please enter Amazon or Flipkart product link');
  }
}
...
const getProductDetails = async (productLink) => {
  try {
    ...
    console.log(e.message);
    throw Error(`Unable to get product details - ${e.message}`);
  }
};
